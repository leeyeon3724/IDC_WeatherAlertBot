...
gate: lint typecheck check-arch check-docs check-alarm-rules check-hygiene check-env-sync test-cov
...
check-alarm-rules:
	$(PYTHON) -m scripts.check_alarm_rules_sync
